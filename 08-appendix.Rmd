...
The zero-input linear time-invariant (LTI) system $\dot{x} = A x$ is
...
One can show that $A$'s eigenvalues determines the zero-input LTI system's stability, as the following Theorem states:
