...
With the above exercises, we can swing the pendulum to a feasible state, and then switch to the LQR phase as implemented in Exercise \@ref(exr:pendulum-lqr-clipped-roa).
