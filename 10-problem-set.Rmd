...
In Exercise \@ref(pendulum-lqr-clipped-roa), we have studied the region of attraction of Clipped LQR Controller. In this exercise, we are going to swing up the pendulum to a stabilizable initial state (the blue circle region in Exercise \@ref(pendulum-lqr-clipped-roa)).
...
With the above exercises, we can swing the pendulum to a stabilizable state, and then switch to the LQR phase as implemented in Exercise \@ref(pendulum-lqr-clipped-roa).
