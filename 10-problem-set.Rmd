...
2. For $k=0,1,2,\ldots$, compute $Q^{\pi_k}$ via \@ref(eq:bellman-consistency-Qpi-linearsystem). Then update policy by greedy method $\pi_{k+1}=\pi_{Q^{\pi_k}}$ (see \@ref(eq:def-pi-Q) for the definition of $\pi_Q$).
