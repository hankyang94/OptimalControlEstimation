...
```{r pendulum-sat-control-random-samples-certificate, out.width='80%', fig.show='hold', fig.cap='Example of stabilized and non-stabilized initial states.', fig.align='center', echo=FALSE}
