...
Then, if the real components of $\mathrm{eig}(A - KC) < 0$, then $e(t) \rightarrow 0$ as $t \rightarrow \infty$, independent of the initial error $e(0) = \xi(0) - \hat{xi}(0)$. 


Subtracting the error dynamics from the true dynamics, we obtain $\dot{e} = A - KC$. 
:::
...
<span style="color:red">TBD: simulate the observer.</span>
:::
:::
...
\Psi_\nu (\tau, t) d \tau
$$
<span style="color:red">Does the transition matrix $\Psi_\nu (\tau, t)$ have an analytical form?</span>
:::
:::
