...
$$
where $a \in \mathbb{R}^m$ contains all the parameters and $Y \in \mathbb{R}^{n \times m}$ is the matrix that collects all the coeffients of $a$. As a result, the adapative control law is naturally
\begin{equation}
\tau = Y \hat{a} - K_D s,
