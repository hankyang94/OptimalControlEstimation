...
Oftentimes, it is insufficient to ensure the estimator converges to the true state asymptotically, and we need to reason about the convergence rate. Particularly, let us define \(e = \hat{x} - x\), and we know
\[
