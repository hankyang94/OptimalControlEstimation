...
::: {.examplebox}
::: {.example #feature-based swinging up a pendulum name="Swinging up a pendulum using feature-based method}
...
::: {.examplebox}
::: {.example #NN-based swinging up a pendulum name="Swinging up a pendulum using NN-based method"}
<span style="color:red">EXPERIMENT HERE</span>
